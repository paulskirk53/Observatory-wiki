...
The ticks per dome rev in the master branch is 20700 and the number of shaft encoder ticks per rev =600, so 20700/ 600 =34.5 the number of shaft rotations per dome rev