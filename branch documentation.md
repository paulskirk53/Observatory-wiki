...
**Control Box**
The current in use branch is master and this has been updated and tested at home on the Control Box simulator with encoder. It can be uploaded to the Observatory Control box in conjunction with the updated Monitor software (lenovo)
...
-  drive using degrees
	- this is to be tested at home with the motor attached see the notes on testing in the top of the code file
